...
backend sportsbookreview.cluster
        ...
        option allbackups
        server 172.22.4.241-varnish 172.22.4.241:6081 check
        server 172.22.4.241-nginx 172.22.4.241:81 cookie A check backup

backend microservices.cluster
        mode http
        balance roundrobin
        server 172.22.4.241-nginx 172.22.4.241:89 check
...
backend posting_forum.cluster
        ...
        server 172.22.4.241-nginx 172.22.4.241:84 cookie A check
...
backend sportsbook_casino.cluster
        mode http
        server 172.22.4.241 172.22.4.241:82 check
...
backend adn.sbr.cluster
        ...
        server 172.22.4.241-nginx 172.22.4.241:85 cookie A check

backend mysbrforum.cluster
        mode http
        balance roundrobin
        cookie JSESSIONID prefix
        server 172.22.4.241-nginx 172.22.4.241:88 cookie A check
